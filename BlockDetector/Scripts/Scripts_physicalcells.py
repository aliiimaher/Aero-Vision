...
mega_tile_dir = "/home/training/BlockDetector/Megatile dataset"  # مسیر فولدر حاوی تصاویر مگاتایل
physical_output_dir = "/home/training/BlockDetector/physicall_Cell"  # مسیر فولدر خروجی
json_dir = "/home/training/BlockDetector/Megatile dataset"  # مسیر فولدر حاوی فایل‌های JSON
grid_height = 1024  # ارتفاع شبکه برای تقسیم‌بندی مگاتایل
grid_width = 1024  # عرض شبکه برای تقسیم‌بندی مگاتایل

# افزایش حداکثر اندازه تصویر
...
def create_physical_cells(image: np.ndarray, grid_height: int, grid_width: int, output_dir: str, json_data: dict, tile_number: int):
    ...
    canvas_size = physical_size + 200  # افزودن حاشیه اضافی برای جلوگیری از کراپ شدن باندینگ باکس‌ها
    ...
    for y in range(0, img_height, grid_height):
        for x in range(0, img_width, grid_width):
            ...
            for shape in json_data['shapes']:
                ...
                # بررسی نقاط کلیدی که حداقل یکی از آن‌ها در تصویر است
                points_in_canvas = [
                ...
                # اگر حداقل یک نقطه کلیدی در تصویر باشد، بقیه نقاط و باندینگ باکس را اضافه می‌کنیم
                if points_in_canvas:
                    ...
                    # ذخیره باندینگ باکس و نقاط کلیدی در داده‌های پیکل
                    obj_data = {
                        'label': str(class_id),
            ...
            # ذخیره تصویر فیزیکی و فایل پیکل در مسیر خروجی
