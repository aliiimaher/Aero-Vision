...
from ultralytics.data.build import InfiniteDataLoader  # Import InfiniteDataLoader
...
# Custom OBB Trainer class to use OBB dataset and InfiniteDataLoader
class CustomOBBTrainer(OBBTrainer):  
    ...
    def get_dataloader(self, images_dir, batch_size, rank, mode):
        ...
        # Use the new PhysicalCellsOBBDataset
        ...
        # Use InfiniteDataLoader instead of the standard DataLoader
        return InfiniteDataLoader(
            dataset=dataset,
            batch_size=batch_size,
            sampler=sampler,  # Set the distributed sampler here
            collate_fn=collate_fn,  # Use the custom collate function for OBB
