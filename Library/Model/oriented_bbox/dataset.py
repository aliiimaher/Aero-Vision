...
class OrientedBBoxDataset(PhysicalCellsObjectDetectionDataset):
    ...
    def create_line_bounding_box(self, pt1, pt2, width=1, img_width=1, img_height=1):
    ...
    def __getitem__(self, idx):
        ...
        if len(clipped_keypoints) > 0:
            for i in range(0, len(clipped_keypoints) - 1, 2):
                ...
                _, (cx, cy, w, h, angle) = self.create_line_bounding_box(pt1, pt2, width=30, img_width=self.sample_size, img_height=self.sample_size)
